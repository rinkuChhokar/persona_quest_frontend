...
import { setIsUserClickedOnSignInButton } from '../features/userLogin/isUserClickedOnSignInButtonSlice';
...
const LoginForm = () => {
    ...
    const isUserClickedOnSignInButton = useSelector((store) => store.isUserClickedOnSignInButton.value);
        ...
        fetch(`${BACKEND_URL}/api/v1/user-login`, {
            ...
            .then((data) => {
                if (data.status == "success") {
                    ...
                    dispatch(setIsUserClickedOnSignInButton(false));
            ...
            <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
                <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
                    <div className="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
                        <form className="space-y-4" ref={loginForm} onSubmit={handleLoginForm}>
                            <div className="mb-8">
                            ...
                            <div className="!mt-8">
                                <button type="submit" className={`w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white ${isUserClickedOnSignInButton ? "bg-slate-700" : "bg-blue-600"} ${isUserClickedOnSignInButton ? "hover:bg-slate-700" : "hover:bg-blue-700"} focus:outline-none`}>
                                    {isUserClickedOnSignInButton ? "Logging in..." : "Log in"}
                                </button>
                            </div>
