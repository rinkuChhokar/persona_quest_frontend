...
import UserTestsPage from '../userDashboardPage/UserTestsPage';
...
const AdminDashboardPage = () => {
    ...
    useEffect(() => {
        ...
        sidebarToggleBtn?.addEventListener('click', sidebarToggleClickHandler);

        // Clean up event listeners when the component unmounts
        return () => {
            toggleOpen?.removeEventListener('click', handleClick);
            toggleClose?.removeEventListener('click', handleClick);
            sidebarToggleBtn?.removeEventListener('click', sidebarToggleClickHandler);
        };
    }, []);
                        ...
                        <nav id="sidebar" className="lg:min-w-[250px] w-max max-lg:min-w-8">
                            <div id="sidebar-collapse-menu" style={{ height: "calc(100vh - 72px)" }}
                                ...
                                <ul className="space-y-2">
                                    <li className={`${location.pathname == "/admin" ? "bg-gray-200 rounded-md" : ""}`}>
                                        <Link to={"/admin"}
                                ...
                                <div className="mt-6">
                                    ...
                                    <ul className="mt-3 space-y-2">
                                        <li className={`${location.pathname == "/admin/user-list" ? "bg-gray-200 rounded-md" : ""}`}>
                                            <Link to={"user-list"}
                                                className="text-gray-800 text-sm flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all">
                                        ...
                                        <li className={`${location.pathname == "/admin/tests" ? "bg-gray-200 rounded-md" : ""}`}>
                                            <Link to={"tests"}
                                                className="text-gray-800 text-sm flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-3"
                                                    viewBox="0 0 24 24">
